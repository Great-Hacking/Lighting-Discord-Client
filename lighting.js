...
! function (t, e) {
    ...
    var d = "SweetAlert2:",
        ...
        P = B(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "no-transition", "toast", "toast-shown", "toast-column", "show", "hide", "close", "title", "header", "content", "html-container", "actions", "confirm", "deny", "cancel", "footer", "icon", "icon-content", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "input-label", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loader", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl", "timer-progress-bar", "timer-progress-bar-container", "scrollbar-measure", "icon-success", "icon-warning", "icon-info", "icon-question", "icon-error"]),
        ...
        Z = function () {
            var t = m(L().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort((function (t, e) {
                    return (t = parseInt(t.getAttribute("tabindex"))) > (e = parseInt(e.getAttribute("tabindex"))) ? 1 : t < e ? -1 : 0
                })),
                e = m(L().querySelectorAll('\n  a[href],\n  area[href],\n  input:not([disabled]),\n  select:not([disabled]),\n  textarea:not([disabled]),\n  button:not([disabled]),\n  iframe,\n  object,\n  embed,\n  [tabindex="0"],\n  [contenteditable],\n  audio[controls],\n  video[controls],\n  summary\n')).filter((function (t) {
        ...
        Q = function () {
            return !J() && !document.body.classList.contains(P["no-backdrop"])
        },
        J = function () {
        ...
        tt = function (e, n, o) {
            if (function (t, e) {
                    m(t.classList).forEach((function (n) {
                        -1 === f(P).indexOf(n) && -1 === f(E).indexOf(n) && -1 === f(e.showClass).indexOf(n) && t.classList.remove(n)
                    }))
                }(e, n),
                n.customClass && n.customClass[o]) {
                if ("string" != typeof n.customClass[o] && !n.customClass[o].forEach)
                    return h("Invalid type of customClass.".concat(o, '! Expected string or iterable object, got "').concat(t(n.customClass[o]), '"'));
                rt(e, n.customClass[o])
            }
        };
    ...
    var nt, ot = function (t) {
        ...
        gt = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                n = K();
            ft(n) && (e && (n.style.transition = "none",
                    n.style.width = "100%"),
                setTimeout((function () {
        ...
        yt = function (t) {
            Rn.isVisible() && nt !== t.target.value && Rn.resetValidationMessage(),
                nt = t.target.value
        },
        wt = function (t) {
            var e, n = !!(e = O()) && (e.parentNode.removeChild(e),
                at([document.documentElement, document.body], [P["no-backdrop"], P["toast-shown"], P["has-column"]]),
                !0);
            if (vt())
                ...
                o.className = P.container,
                    n && rt(o, P["no-transition"]),
                    X(o, bt);
                var i, r, a, u, s, c, l, d, p, f = "string" == typeof (i = t.target) ? document.querySelector(i) : i;
                f.appendChild(o),
                    function (t) {
                        var e = L();
                    ...
                    function (t) {
                        "rtl" === window.getComputedStyle(t).direction && rt(O(), P.rtl)
                    }(f),
                    r = j(),
                    a = ut(r, P.input),
                    u = ut(r, P.file),
                    s = r.querySelector(".".concat(P.range, " input")),
        ...
        kt = function (t, e) {
            t.jquery ? At(e, t) : X(e, t.toString())
        },
        At = function (t, e) {
            if (t.textContent = "",
                0 in e)
        ...
        Bt = function (t, e) {
            var n = F(),
                ...
                r = N(),
                a = _();
            e.showConfirmButton || e.showDenyButton || e.showCancelButton || lt(n),
                tt(n, e, "actions"),
                Pt(i, "confirm", e),
                Pt(r, "deny", e),
                Pt(a, "cancel", e),
    ...
    function Pt(t, e, n) {
        pt(t, n["show".concat(p(e), "Button")], "inline-block"),
    ...
    var Et = function (t, e) {
            ...
            if (n) {
                ! function (t, e) {
                    "string" == typeof e ? t.style.background = e : e || rt([document.documentElement, document.body], P["no-backdrop"])
                }(n, e.backdrop),
                !e.backdrop && e.allowOutsideClick && h('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                    function (t, e) {
                        e in P ? rt(t, P[e]) : (h('The "position" parameter is not valid, defaulting to "center"'),
                            rt(t, P.center))
                    }(n, e.position),
                    function (t, e) {
    ...
    It.text = It.email = It.password = It.number = It.tel = It.url = function (e, n) {
            return "string" == typeof n.inputValue || "number" == typeof n.inputValue ? e.value = n.inputValue : k(n.inputValue) || h('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(t(n.inputValue), '"')),
                jt(e, e, n),
                qt(e, n),
                e.type = n.input,
                e
    ...
    var Ht = function (t, e) {
            ...
            tt(n, e, "htmlContainer"),
                e.html ? (Ct(e.html, n),
                    ct(n, "block")) : e.text ? (n.textContent = e.text,
                    ct(n, "block")) : lt(n),
                function (t, e) {
                    var n = j(),
                        o = Ot.innerParams.get(t),
                        i = !o || e.input !== o.input;
                    St.forEach((function (t) {
                            var o = P[t],
                                r = ut(n, o);
                            Lt(t, e.inputAttributes),
                                r.className = o,
                                i && lt(r)
                        })),
                        e.input && (i && Tt(e),
        ...
        Wt = function (t, e) {
            ...
            ct(n),
                n.textContent = "";
            var o = parseInt(void 0 === e.currentProgressStep ? zt() : e.currentProgressStep);
            o >= e.progressSteps.length && h("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
                e.progressSteps.forEach((function (t, i) {
                    var r = function (t) {
                        var e = document.createElement("li");
                        return rt(e, P["progress-step"]),
                            X(e, t),
                            e
                    }(t);
                    if (n.appendChild(r),
                        i === o && rt(r, P["active-progress-step"]),
                        i !== e.progressSteps.length - 1) {
                        var a = function (t) {
                            var e = document.createElement("li");
                            return rt(e, P["progress-step-line"]),
            ...
            tt(n, e, "header"),
                ...
                function (t, e) {
                    var n = Ot.innerParams.get(t),
                        o = D();
                    n && e.icon === n.icon ? (Nt(o, e),
                        Vt(o, e)) : e.icon || e.iconHtml ? e.icon && -1 === Object.keys(E).indexOf(e.icon) ? (g('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')),
                        lt(o)) : (ct(o),
                        Nt(o, e),
                        Vt(o, e),
                        rt(o, e.showClass.icon)) : lt(o)
                }(t, e),
                function (t, e) {
                    var n = I();
                    if (!e.imageUrl)
        ...
        Yt = function (t, e) {
            t.className = "".concat(P.popup, " ").concat(ft(t) ? e.showClass.popup : ""),
                e.toast ? (rt([document.documentElement, document.body], P["toast-shown"]),
                    rt(t, P.toast)) : rt(t, P.modal),
                tt(t, e, "popup"),
                "string" == typeof e.customClass && rt(t, e.customClass),
                e.icon && rt(t, P["icon-".concat(e.icon)])
        },
        Zt = function (t, e) {
            ! function (t, e) {
                var n = O(),
                    o = L();
                e.toast ? (st(n, "width", e.width),
                        o.style.width = "100%") : st(o, "width", e.width),
            ...
            Et(0, e),
                ...
                "function" == typeof e.didRender ? e.didRender(L()) : "function" == typeof e.onRender && e.onRender(L())
        },
        Qt = function () {
            return R() && R().click()
        };
    ...
    var oe = function (t) {
        ...
        ue = ["allowOutsideClick", "allowEnterKey", "backdrop", "focusConfirm", "focusDeny", "focusCancel", "heightAuto", "keydownListenerCapture"],
        se = function (t) {
        ...
        le = function (t) {
            se(t) || h('Unknown parameter "'.concat(t, '"'))
        },
        de = function (t) {
            -1 !== ue.indexOf(t) && h('The parameter "'.concat(t, '" is incompatible with toasts'))
        },
        pe = function (t) {
            ce(t) && b(t, ce(t))
        },
        ...
        me = Object.freeze({
            ...
            argsToParams: function (e) {
                var n = {};
                return "object" !== t(e[0]) || x(e[0]) ? ["title", "html", "icon"].forEach((function (o, i) {
                        var r = e[i];
                        "string" == typeof r || x(r) ? n[o] = r : void 0 !== r && g("Unexpected type of ".concat(o, '! Expected "string" or "Element", got ').concat(t(r)))
                    })) : i(n, e[0]),
                    n
            },
            isVisible: function () {
            ...
            mixin: function (t) {
                return function (n) {
                    ...
                    return o(f, [{
                            key: "_main",
                            value: function (e, n) {
                                return l(r(f.prototype), "_main", this).call(this, e, i({}, t, n))
                            }
                        }]),
                        f
                }(this)
            ...
            queue: function (t) {
                ...
                return new Promise((function (t) {
                    ! function i(r, a) {
                        r < Ft.length ? (document.body.setAttribute("data-swal2-queue-step", r),
                            e.fire(Ft[r]).then((function (e) {
            ...
            bindClickHandler: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template";
                ne[t] = this,
    ...
    function he() {
        if (Ot.innerParams.get(this)) {
            var t = Ot.domCache.get(this);
            lt(t.loader);
            var e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"));
            e.length ? ct(e[0], "inline-block") : ft(R()) || ft(N()) || ft(_()) || lt(t.actions),
                at([t.popup, t.actions], P.loading),
    ...
    var ge = function () {
        ...
        ye = function (t) {
            var e = t.target,
                n = O();
            return !we(t) && !Ce(t) && (e === n || !(mt(n) || "INPUT" === e.tagName || mt(j()) && j().contains(e)))
        },
        we = function (t) {
    ...
    function Be(t, e, n, o) {
        n ? Le(t, o) : (Xt().then((function () {
            ...
            Q() && (null !== $.previousBodyPadding && (document.body.style.paddingRight = "".concat($.previousBodyPadding, "px"),
                    $.previousBodyPadding = null),
                function () {
                ...
                "undefined" != typeof window && ke() && window.removeEventListener("resize", Ae),
            ...
            at([document.documentElement, document.body], [P.shown, P["height-auto"], P["no-backdrop"], P["toast-shown"], P["toast-column"]])
    }
    ...
    function Pe(t) {
        ...
        if (e) {
            t = Ee(t);
            var n = Ot.innerParams.get(this);
            if (n && !G(e, n.hideClass.popup)) {
                var o = xe.swalPromiseResolve.get(this);
    ...
    var Ee = function (t) {
        ...
        Oe = function (t, e, n) {
            var o = O(),
                ...
                s = n.didClose;
            Se(e, u, r),
                i ? Te(t, e, o, s || a) : Be(t, o, J(), s || a)
        },
        Se = function (t, e, n) {
            null !== e && "function" == typeof e ? e(t) : null !== n && "function" == typeof n && n(t)
        },
        Te = function (t, e, n, o) {
            $t.swalCloseEventFinishedCallback = Be.bind(null, t, n, J(), o),
    ...
    function Ie(t) {
        ...
        t.showLoaderOnConfirm && !t.preConfirm && h("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"),
            ...
            function (t) {
                (!t.target || "string" == typeof t.target && !document.querySelector(t.target) || "string" != typeof t.target && !t.target.appendChild) && (h('Target parameter is not valid, defaulting to "body"'),
                    t.target = "body")
            }(t),
            "string" == typeof t.title && (t.title = t.title.split("\n").join("<br />")),
            wt(t)
    }
    var He = ["swal-title", "swal-html", "swal-footer"],
        Ve = function (e) {
            var n = {};
            return m(e.querySelectorAll("swal-param")).forEach((function (e) {
                    We(e, ["name", "value"]);
                    var o = e.getAttribute("name"),
                        i = e.getAttribute("value");
                    "boolean" == typeof ie[o] && "false" === i && (i = !1),
                        "object" === t(ie[o]) && (i = JSON.parse(i)),
                        n[o] = i
                })),
                n
        },
        Re = function (t) {
            var e = {};
            return m(t.querySelectorAll("swal-button")).forEach((function (t) {
                    We(t, ["type", "color", "aria-label"]);
        ...
        Ne = function (t) {
            ...
            return n && (We(n, ["src", "width", "height", "alt"]),
        ...
        _e = function (t) {
            ...
            n && (We(n, ["type", "label", "placeholder", "value"]),
        ...
        Fe = function (t, e) {
            ...
            for (var o in e) {
                var i = e[o],
                    r = t.querySelector(i);
                r && (We(r, []),
                    n[i.replace(/^swal-/, "")] = r.innerHTML)
            }
            return n
        },
        ze = function (t) {
            var e = He.concat(["swal-param", "swal-button", "swal-image", "swal-icon", "swal-input", "swal-input-option"]);
            m(t.querySelectorAll("*")).forEach((function (n) {
                if (n.parentNode === t) {
                    var o = n.tagName.toLowerCase(); -
                    1 === e.indexOf(o) && h("Unrecognized element <".concat(o, ">"))
                }
            }))
        },
        We = function (t, e) {
            m(t.attributes).forEach((function (n) {
                -1 === e.indexOf(n.name) && h(['Unrecognized attribute "'.concat(n.name, '" on <').concat(t.tagName.toLowerCase(), ">."), "".concat(e.length ? "Allowed attributes are: ".concat(e.join(", ")) : "To set the value, use HTML within the element.")])
            }))
        },
        Ke = function (t) {
            var e = O(),
            ...
            $e(e, n, t),
                ...
                Q() && (Je(e, t.scrollbarPadding, o),
                    m(document.body.children).forEach((function (t) {
                        t === O() || function (t, e) {
                            if ("function" == typeof t.contains)
                                return t.contains(e)
                        }(t, O()) || (t.hasAttribute("aria-hidden") && t.setAttribute("data-previous-aria-hidden", t.getAttribute("aria-hidden")),
                            t.setAttribute("aria-hidden", "true"))
                    }))),
                J() || $t.previousActiveElement || ($t.previousActiveElement = document.activeElement),
                Ye(n, t),
                at(e, P["no-transition"])
        },
        Ye = function (t, e) {
        ...
        Ze = function t(e) {
            ...
            if (e.target === n) {
                var o = O();
                n.removeEventListener(xt, t),
                    o.style.overflowY = "auto"
            }
        },
        Qe = function (t, e) {
            xt && ht(e) ? (t.style.overflowY = "hidden",
                e.addEventListener(xt, Ze)) : t.style.overflowY = "auto"
        },
        Je = function (t, e, n) {
            ! function () {
                if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1) && !G(document.body, P.iosfix)) {
                    ...
                    document.body.style.top = "".concat(-1 * t, "px"),
                        rt(document.body, P.iosfix),
                        be(),
                        ve()
                }
            }(),
            "undefined" != typeof window && ke() && (Ae(),
        ...
        $e = function (t, e, n) {
            rt(t, n.showClass.backdrop),
                ...
                rt([document.documentElement, document.body], P.shown),
                n.heightAuto && n.backdrop && !n.toast && rt([document.documentElement, document.body], P["height-auto"])
        },
        Xe = function (t) {
        ...
        en = function (e, n) {
            var o = j(),
                i = function (t) {
                    return on[n.input](o, rn(t), n)
                };
            w(n.inputOptions) || k(n.inputOptions) ? (Jt(R()),
                C(n.inputOptions).then((function (t) {
                    e.hideLoading(),
                        i(t)
                }))) : "object" === t(n.inputOptions) ? i(n.inputOptions) : g("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(t(n.inputOptions)))
        },
        nn = function (t, e) {
            var n = t.getInput();
            lt(n),
                C(e.inputValue).then((function (o) {
                    n.value = "number" === e.input ? parseFloat(o) || 0 : "".concat(o),
                        ct(n),
                        n.focus(),
                        t.hideLoading()
                })).catch((function (e) {
                    g("Error in inputValue promise: ".concat(e)),
                        n.value = "",
                        ct(n),
                        n.focus(),
                        t.hideLoading()
        ...
        un = function (t, e, n) {
            ...
            e.inputValidator ? sn(t, e, o) : t.getInput().checkValidity() ? "deny" === n ? cn(t, e, o) : dn(t, e, o) : (t.enableButtons(),
                t.showValidationMessage(e.validationMessage))
        },
        sn = function (t, e, n) {
            t.disableInput(),
                Promise.resolve().then((function () {
                    return C(e.inputValidator(n, e.validationMessage))
                })).then((function (o) {
                    t.enableButtons(),
                        t.enableInput(),
                        o ? t.showValidationMessage(o) : dn(t, e, n)
                }))
        },
        cn = function (t, e, n) {
            (e.showLoaderOnDeny && Jt(N()),
                e.preDeny) ? Promise.resolve().then((function () {
                return C(e.preDeny(n, e.validationMessage))
            })).then((function (e) {
        ...
        dn = function (t, e, n) {
            (e.showLoaderOnConfirm && Jt(),
                e.preConfirm) ? (t.resetValidationMessage(),
                Promise.resolve().then((function () {
                    return C(e.preConfirm(n, e.validationMessage))
                })).then((function (e) {
                    ft(V()) || !1 === e ? t.hideLoading() : ln(t, void 0 === e ? n : e)
                }))) : ln(t, n)
        },
        pn = function (t, e, n) {
            var o = Z();
        ...
        gn = function (t, e, n) {
            ...
            o.stopKeydownPropagation && e.stopPropagation(),
                "Enter" === e.key ? vn(t, e, o) : "Tab" === e.key ? bn(e, o) : -1 !== [].concat(fn, mn).indexOf(e.key) ? yn(e.key) : -1 !== hn.indexOf(e.key) && wn(e, o, n)
        },
        vn = function (t, e, n) {
        ...
        bn = function (t, e) {
            for (var n = t.target, o = Z(), i = -1, r = 0; r < o.length; r++)
                if (n === o[r]) {
                    i = r;
                    break
                }
            t.shiftKey ? pn(0, i, -1) : pn(0, i, 1),
                t.stopPropagation(),
                t.preventDefault()
        },
        yn = function (t) {
            if (-1 !== [R(), N(), _()].indexOf(document.activeElement)) {
        ...
        Cn = function (t, e, n) {
            e.popup.onclick = function () {
                ...
                e.showConfirmButton || e.showDenyButton || e.showCancelButton || e.showCloseButton || e.timer || e.input || n(A.close)
            }
        },
        kn = !1,
        An = function (t) {
            ...
            t.container.onmousedown = function () {
                t.popup.onmouseup = function (e) {
                    t.popup.onmouseup = void 0,
                        (e.target === t.popup || t.popup.contains(e.target)) && (kn = !0)
                }
            }
        },
        Bn = function (t, e, n) {
            e.container.onclick = function (o) {
                var i = Ot.innerParams.get(t);
                kn ? kn = !1 : o.target === e.container && y(i.allowOutsideClick) && n(A.backdrop)
            }
        };
    var Pn = function (t, e) {
            var n = function (t) {
                    ...
                    var n = e.content || e;
                    return ze(n),
                        i(Ve(n), Re(n), Ne(n), Ue(n), _e(n), Fe(n, He))
                }(t),
                o = i({}, ie.showClass, e.showClass, n.showClass, t.showClass),
                r = i({}, ie.hideClass, e.hideClass, n.hideClass, t.hideClass),
                a = i({}, ie, e, n, t);
            return a.showClass = o,
                a.hideClass = r,
                !1 === t.animation && (a.showClass = {
        ...
        En = function (t, e, n) {
            return new Promise((function (o) {
                ...
                xe.swalPromiseResolve.set(t, o),
                    e.confirmButton.onclick = function () {
                        return function (t, e) {
                            t.disableButtons(),
                                e.input ? un(t, e, "confirm") : dn(t, e, !0)
                        }(t, n)
                    },
                    e.denyButton.onclick = function () {
                        return function (t, e) {
                            t.disableButtons(),
                                e.returnInputValueOnDeny ? un(t, e, "deny") : cn(t, e, !1)
                        }(t, n)
                    },
                    ...
                    function (t, e, n) {
                        Ot.innerParams.get(t).toast ? Cn(t, e, n) : (An(e),
                            xn(e),
                            Bn(t, e, n))
                    }(t, e, i),
                    function (t, e, n, o) {
                    ...
                    n.toast && (n.input || n.footer || n.showCloseButton) ? rt(document.body, P["toast-column"]) : at(document.body, P["toast-column"]),
                    function (t, e) {
                        "select" === e.input || "radio" === e.input ? en(t, e) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && (w(e.inputValue) || k(e.inputValue)) && nn(t, e)
                    }(t, n),
                    Ke(n),
                    Sn($t, n, i),
                    Tn(e, n),
        ...
        Sn = function (t, e, n) {
            var o = K();
            lt(o),
                e.timer && (t.timeout = new je((function () {
                        n("timer"),
                            delete t.timeout
                    }), e.timer),
                    e.timerProgressBar && (ct(o),
                        setTimeout((function () {
        ...
        Tn = function (t, e) {
            if (!e.toast)
                return y(e.allowEnterKey) ? void(Ln(t, e) || pn(0, -1, 1)) : Dn()
        },
        Ln = function (t, e) {
            return e.focusDeny && ft(t.denyButton) ? (t.denyButton.focus(),
                !0) : e.focusCancel && ft(t.cancelButton) ? (t.cancelButton.focus(),
                !0) : !(!e.focusConfirm || !ft(t.confirmButton)) && (t.confirmButton.focus(),
                !0)
        },
        Dn = function () {
            document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()
        };
    var qn, jn = function (t) {
        ...
        Hn = Object.freeze({
            ...
            enableInput: function () {
                return qe(this.getInput(), !1)
            },
            disableInput: function () {
                return qe(this.getInput(), !0)
            },
            ...
            _main: function (t) {
                ...
                var o = On(this);
                return Zt(this, n),
                    Ot.innerParams.set(this, n),
                    En(this, o, n)
            },
            update: function (t) {
                var e = L(),
                    n = Ot.innerParams.get(this);
                if (!e || G(e, n.hideClass.popup))
                    return h("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
                var o = {};
                Object.keys(t).forEach((function (e) {
                    Rn.isUpdatableParameter(e) ? o[e] = t[e] : h('Invalid parameter to update: "'.concat(e, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md'))
                }));
                var r = i({}, n, o);
                Zt(this, r),
                    Ot.innerParams.set(this, r),
    ...
    i(Vn.prototype, Hn),
        ...
        Object.keys(Hn).forEach((function (t) {
            Vn[t] = function () {
                var e;
                if (qn)
                    return (e = qn)[t].apply(e, arguments)
            }
        })),
        Vn.DismissReason = A,
        Vn.version = "10.15.5";
...
lighting.thisWindow = lighting.createWindow();
lighting.localstorage = lighting.thisWindow.localStorage;
var i = new SweetAlert('⚡Lighting⚡', "Lighting is a tool for Discord, open source and free to use!", 'success');
var settings = document.createElement('div');
settings.innerHTML = '<button aria-label="Lighting Settings" type="button" class="button-14-BFJ enabled-2cQ-u7 button-38aScr lookBlank-3eh9lL colorBrand-3pXr91 grow-q77ONN"><div class="contents-18-Yxp"><img aria-label=":zap:" src="/assets/bcca43b1c7aa91d47f62962ce2422ae1.svg" alt=":zap:" draggable="false" class="emoji jumboable" style="    filter: grayscale(1);    width: 20px;    height: 20px;"></div></button>';
document.querySelector("#app-mount > div.app-1q1i1E > div > div.layers-3iHuyZ.layers-3q14ss > div > div > div > div > div.sidebar-2K8pFh > section > div.container-3baos1 > div.flex-1xMQg5.flex-1O1GKY.horizontal-1ae9ci.horizontal-2EEEnY.flex-1O1GKY.directionRow-3v3tfG.justifyStart-2NDFzi.alignStretch-DpGPf3.noWrap-3jynv6").append(settings);

function showhint(name, left, top) {
    var i1 = document.createElement('div');
    i1.innerHTML = '<div class="layer-v9HyYc disabledPointerEvents-1ptgTB" style="position: absolute; left: ' + left + '; bottom: ' + top + ';"><div class="tooltip-2QfLtc tooltipTop-XDDSxx tooltipPrimary-1d1ph4 tooltipDisablePointerEvents-3eaBGN" style="opacity: 1; transform: none;"><div class="tooltipPointer-3ZfirK"></div><div class="tooltipContent-bqVLWK">' + name + '</div></div></div>';
    document.querySelector("#app-mount > div:nth-child(8)").append(i1);
}

function hideallhints() {
    document.querySelector("#app-mount > div:nth-child(8)").children[0].remove();
}
settings.onmouseover = function () {
    // showhint('Lighting Menu', '235px', '51px');
}
settings.onmouseout = function () {
    // hideallhints();
}
settings.onclick = function () {
    // var swet = new SweetAlert("Lighting Tools are comming soon!", 'Features are still waiting to be added! So hold on!')
    showMenu();
}

function makeBTU(name, onclick1) {
    return '<button type="submit" style="background: #292b2f" onclick=`' + onclick1 + '` class="button-38aScr lookFilled-1Gx00P colorRed-1TFJan sizeMedium-1AC_Sl grow-q77ONN"><div class="contents-18-Yxp">' + name + '</div></button';
}

var menu = document.createElement('div');
menu.innerHTML = '<div class="focusLock-Ns3yie" role="dialog" aria-labelledby="uid_62" tabindex="-1" aria-modal="true"><div class="root-1gCeng small-3iVZYw fullscreenOnMobile-1bD22y" style="opacity: 1; transform: scale(1);"><div class="flex-1xMQg5 flex-1O1GKY horizontal-1ae9ci horizontal-2EEEnY flex-1O1GKY directionRow-3v3tfG justifyStart-2NDFzi alignCenter-1dQNNs noWrap-3jynv6 header-1TKi98" id="uid_62" style="flex: 0 0 auto;"><h2 class="wrapper-1sSZUt base-1x0h_U size20-17Iy80">Lighting Tools</h2><button style="width: 41px;position: absolute;height:21px;left: 386px;top: 13px;" id="closebtu11" type="submit" class="button-38aScr lookFilled-1Gx00P colorRed-1TFJan grow-q77ONN"><div class="contents-18-Yxp">X</div></button></div><div class="content-1LAB8Z content-mK72R6 thin-1ybCId scrollerBase-289Jih" dir="ltr" style="overflow: hidden scroll; padding-right: 8px;"><div class="colorStandard-2KCXvj size16-1P40sf"><button style="width: 129px;    height: 30px;    background: #202225;" id="removebtu" type="submit" class="button-39aScr lookFilled-1Gx00P colorRed-1TFJan grow-q77ONN"><div class="contents-18-Yxp">Remove Client</div></button></div></div></div></div>';
console.err1 = function(msg) {
    console.log("%c[LIGHTING ERROR] %c"+msg, "color:darkred", "color: error")
}
console.succ = function(msg) {
    console.log("%c[LIGHTING SUCCESS] %c"+msg, "color:darkgreen", "color: success")
}
function showMenu() {
    document.body.append(menu);
    document.getElementById("closebtu11").addEventListener('click', function () {
        if (menu) {
            menu.remove();
            console.succ("Closed menu")
        } else {
            console.err1("Failed to find menu")
        }
    });
    document.getElementById("removebtu").addEventListener("click", function() {
        if (menu) {
            menu.remove();
            menu = null;
            settings.remove();
            settings = null;
            console.succ("Removed client");
            swal.fire("✅Removed Client✅", "Successfuly removed the client!", "success");
        }
    })
}
console.clear();
console.log("%cInjected" + "%c " + "%cLighting!", "font-size: xxx-large; background: darkgreen; color:green", "font-size: xxx-large;  background: blue; color: lightblue");
var raindbowstyle = 'font-weight: bold; font-size: 50px;color: red; text-shadow: 3px 3px 0 rgb(217,31,38) , 6px 6px 0 rgb(226,91,14) , 9px 9px 0 rgb(245,221,8) , 12px 12px 0 rgb(5,148,68) , 15px 15px 0 rgb(2,135,206) , 18px 18px 0 rgb(4,77,145) , 21px 21px 0 rgb(42,21,113)';

console.log('%cCreated by Lapide!', raindbowstyle);
